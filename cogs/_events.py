...
class _events(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        ...
        if isinstance(error, commands.CommandNotFound):
            ...
            print("CusTOM EXCEPTION",error.error)
            ...
            embed.description = str(error)
        elif isinstance(error, models.NotFound):
            embed.set_author(icon_url=icon_url, name="Object not found!")
            embed.description = str(error)
        else:
    ...
    async def update_status(self):
        ...
        statuses = [
            {"type": "playing", "message": "https://github.com/timraay/FeedbackBot"}
        ]
